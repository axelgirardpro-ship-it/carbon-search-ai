...
const Index = () => {
  return <div className="min-h-screen bg-background">
      ...
      <nav className="bg-background border-b border-border sticky top-0 z-50">
        ...
        <div className="flex-shrink-0">
          <img src="/lovable-uploads/7be407bf-f3a0-4d7c-81d3-4f160d957e96.png" alt="DataCarb" className="h-20" />
        </div>
  ...
  <Tabs defaultValue="donnees" className="max-w-6xl mx-auto">
    <TabsList className="grid w-full grid-cols-4 mb-12 bg-[#CEC3FF] rounded-full items-center">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          ...
          <Tabs defaultValue="standards" className="max-w-6xl mx-auto">
            <TabsList className="grid w-full grid-cols-2 mb-12 bg-[#CEC3FF] rounded-full items-center">
